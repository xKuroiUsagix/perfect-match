...
ASK_UPDATE_DESCRIPTION_MESSAGE = 'Надішли мені свій новий опис профілю'
ASK_UPDATE_NAME_MESSAGE = 'Надішли мені своє нове ім\'я'
ASK_UPDATE_AGE_MESSAGE = 'Змінився вік? 🤨\n\nСподіваюсь просто недавно був день народження. Вкажи свій новий вік'
ASK_UPDATE_CITY_MESSAGE = 'Нове місто? Звучить цікаво. Відправ мені його назву'
ASK_UPDATE_PHOTOS_MESSAGE = f'Набридли старі фото? Нічого, я щойно їх видалив. Тепер надішли нові, не більше ніж {PHOTO_LIMIT}'
